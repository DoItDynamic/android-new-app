 ...
 */
public class Impresum extends Activity {

    public Impresum(Activity activity) {
        //About
        ...
        alertDialog.setTitle("Impresum");

        // Setting Dialog Message
        //alertDialog2.setMessage(Html.fromHtml(getResources().getString(R.string.agreement)));
        alertDialog.setMessage(Html.fromHtml(activity.getResources().getString(R.string.impresum)));
